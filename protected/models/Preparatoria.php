...
/**
 * This is the model class for table "Preparatoria".
 *
 * The followings are the available columns in table 'Preparatoria':
 * @property string $id
 ...
 */
class Preparatoria extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Preparatoria the static model class
	 */
